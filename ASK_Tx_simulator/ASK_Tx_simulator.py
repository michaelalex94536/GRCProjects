...
# Title: Simulate ASK transmission
...
class ASK_Tx_simulator(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Simulate ASK transmission", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simulate ASK transmission")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ASK_Tx_simulator")
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_vector_source_x_0 = blocks.vector_source_c((0, 0, 1/4, 2/4, 3/4, 4/4), True, 1, [])
...
def main(top_block_cls=ASK_Tx_simulator, options=None):
