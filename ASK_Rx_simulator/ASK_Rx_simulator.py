...
class ASK_Rx_simulator(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Simulate ASK reception", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simulate ASK reception")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ASK_Rx_simulator")
        ...
        # Variables
        ##################################################
        self.samps_per_sym = samps_per_sym = 128
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "Transmitted signal spectrum", #name
            1,
            None # parent
        )
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_win, 4, 0, 1, 2)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
...
def main(top_block_cls=ASK_Rx_simulator, options=None):
