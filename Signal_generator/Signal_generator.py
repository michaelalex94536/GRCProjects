...
# Title: Real and complex signals
...
class Signal_generator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Real and complex signals", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Real and complex signals")
        ...
        self.freq = freq = 5.1e3

        ##################################################
        # Blocks
        ##################################################
        self._freq_range = Range(-100e3, 100e3, 0.05, 5.1e3, 200)
