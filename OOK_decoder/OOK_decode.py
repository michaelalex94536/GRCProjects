...
# Title: OOK decoder
# Description: View OOK key fob signal
...
class OOK_decode(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OOK decoder", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OOK decoder")
        ...
        self.settings = Qt.QSettings("GNU Radio", "OOK_decode")
...
def main(top_block_cls=OOK_decode, options=None):
